...
type SliverRPCClient interface {
	...
	Portscan(ctx context.Context, in *sliverpb.PortscanReq, opts ...grpc.CallOption) (*sliverpb.Portscan, error)
...
func (c *sliverRPCClient) Portscan(ctx context.Context, in *sliverpb.PortscanReq, opts ...grpc.CallOption) (*sliverpb.Portscan, error) {
	out := new(sliverpb.Portscan)
	err := c.cc.Invoke(ctx, "/rpcpb.SliverRPC/Portscan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SliverRPCServer interface {
	...
	Portscan(context.Context, *sliverpb.PortscanReq) (*sliverpb.Portscan, error)
...
func (UnimplementedSliverRPCServer) Portscan(context.Context, *sliverpb.PortscanReq) (*sliverpb.Portscan, error) {
...
func _SliverRPC_Portscan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(sliverpb.PortscanReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).Portscan(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcpb.SliverRPC/Portscan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).Portscan(ctx, req.(*sliverpb.PortscanReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SliverRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Portscan",
			Handler:    _SliverRPC_Portscan_Handler,
		},
		{
			MethodName: "Netstat",
